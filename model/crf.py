...
def allowed_transitions(constraint_type, labels) -> List[Tuple[int, int]]:
    """
...
class ConditionalRandomField(torch.nn.Module):
    ...
    def _input_likelihood(self, logits, mask) -> torch.Tensor:
        """
    ...
    def forward(self,
                inputs,
                tags,
                mask = None, input_batch_first=False, keepdim=False) -> torch.Tensor:
        """
    ...
    def viterbi_tags(self,
                     logits,
                     mask, logits_batch_first=False) -> List[Tuple[List[int], float]]:
        """
